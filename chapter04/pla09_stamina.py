...
while True:
    # 出目を決める
    if turn==1 and place[0]>place[1] and money[1]>0:
        k="1"
    else:
        k=input_check()

    if k=="s":
        num=random.randint(1,stamina[turn])
        print(f"出目:{num}")
        move(num)
...
if stamina[0]>stamina[1]:
    print("スタミナ的勝利:player")
elif stamina[0]<stamina[1]:
    print("スタミナ的勝利:com")
else:
    print("スタミナ的勝利:なし")
print(f"スタミナ:player{stamina[0]}枚,com{stamina[1]}枚")
